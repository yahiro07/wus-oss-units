...
var ThreePiece = function (id, w, h, useDirtyFlag) {
  ...
  this.macro = {
    light: {
      obj: "group",
      data: [{ obj: "directionalLight" }, { obj: "hemisphereLight" }],
    },
...
ThreePiece.prototype.eval = function (arr_or_json) {
  var json;
  if (Array.isArray(arr_or_json)) {
    // (2)
    json = {
      scale: 0.2,
      data: arr_or_json,
    };
  } else if ("data" in arr_or_json) {
    // (3)
...
ThreePiece.prototype.evalNodeGroup = function (json) {
  ...
  if (this.scene) this.scene.add(node);
...
ThreePiece.prototype.evalNode = function (json) {
  ...
  switch (obj.toLowerCase()) {
    // Texture
    case "texture":
      this.texture[o.name] = THREE.ImageUtils.loadTexture(
        o.file,
        null,
        function () {
          self.textureLoaded++;
...
ThreePiece.prototype.checkMouseOver = function (e) {
  ...
  if (objname != this.mouseOverObj) {
    if (
      this.mouseOverObj !== undefined &&
      this.mouseLeaveFunc[this.mouseOverObj] !== undefined
    ) {
